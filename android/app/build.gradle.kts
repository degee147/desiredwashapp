...
val debugKeystoreProps = Properties().apply {
    // debug.keystore has fixed default passwords — no properties file needed
}
...
android {
    ...
    defaultConfig {
        applicationId = "com.desiredwash.app"
